...
export const CHAIN_CONFIGS: ChainConfigs = {
  ...
  "atlantic-2": {
    ...
    exampleAddresses: {
      ...
      validator:
        "sei18l6zzyyhrl7j9zw2lew50677va25rtsa2s43j9se47f0k" as ValidatorAddr,
    },
    explorerLink: {
      validator: "https://www.mintscan.io/sei/validators",
      proposal: "https://www.mintscan.io/sei/proposals",
    },
  },
  oatchain: {
    chain: "osmosis",
    registryChainName: "oatchain",
    prettyName: "Oat Chain",
    lcd: "https://oatchain-api.alleslabs.dev/lcd",
    rpc: "https://oatchain-api.alleslabs.dev/rpc/",
    indexer: "https://oatchain-api.alleslabs.dev/graphql/v1/graphql",
    api: "https://oatchain-api.alleslabs.dev/api",
    features: {
      faucet: {
        enabled: false,
      },
